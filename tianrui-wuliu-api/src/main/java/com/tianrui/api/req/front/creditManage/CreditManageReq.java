package com.tianrui.api.req.front.creditManage;

import com.tianrui.api.req.BaseReq;

public class CreditManageReq extends BaseReq {
	private static final long serialVersionUID = -5617836132014032882L;
