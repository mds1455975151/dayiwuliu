        ...
        <div class="rz_right">
           ...
           <div class="goods_line" id="select01">
                ...
                <div class="goods_line" id="select02">
                    <label> 路线：</label>
                   <input type="text" placeholder=" " id="routename_v">
                    <input type="hidden" id="routename_v_id" name="routeid">
                </div>
                <div class="goods_line" id="select03">
                    <label> 运价策略：</label>
                    <input type="text" onblur="FreightChange();" placeholder=" " id="freightname_v" value="${freightResp.desc1 }">
                    <input type="hidden" id="freightname_v_id" value="${plan.freightid }" name="freightid">
                </div>
                ...
                <div class="goods_line">
                    <label> 计划总量：</label>
                    <input type="text" value="${plan.totalplanned }" name="totalplanned" placeholder="" onblur="countCost();" id ="totalplanned">
...
<script type="text/javascript" src="<%=basePath%>/resources/js/member/cargo/save_mouid.js" ></script>
</html>