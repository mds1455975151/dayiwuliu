			    ...
			    <div class="row">
		            ...
		            <div class="rz_right">
		                ...
		                <div class="car_box">
		                    ...
		                    <div class="reg_tel">
		                        <label>车&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;长：</label>
		                        <input type="text" placeholder="" id="vehicle_add_vehiLength">
		                        米
		                        <p id="message_vehiLength"></p>
		                    </div>
		                    <div class="reg_tel">
		                        <label>载&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;重：</label>
		                        <input type="text" placeholder="" id="vehicle_add_vehiWeight">
		                        吨
		                        <p id="message_vehiWeight"></p>
		                    </div>
		                    <div class="reg_tel">
		                        <label>所有人姓名：</label>
		                        <input type="text" id="vehicle_add_vehiOwnerName">
