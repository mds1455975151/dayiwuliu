...
<body>
	...
	<div class="bghui">
		<div class="container">
			<div class="row">
				<div class="rz_line">
					<label>当前位置：运单</label><span>></span> <label>货主运单报表</label>
				</div>
			</div>
			<div class="row">
				...
				<div class="car_right">
					<div class="car_title bgblue">
						<h2>货主运单报表</h2>
						<!-- 1-司机，2-车主，3-货主 -->
						<input type="hidden" id="reportType" value="3"> <span
							class="exportReport">导出报表</span>
					</div>
					<!--个人中心右侧搜索框begin-->
					<!--个人中心右侧搜索框begin-->
					<div class="bb_total">
						<div class="bb_search ">
							<div class="bb_line">
								<div class="bb_czline">
									<label>业务日期开始：</label> <input type="text"
										id="businessTimeStart"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate_cz"
										style="width: 140px" />
								</div>
								<div class="bb_czline">
									<label>业务日期结束：</label> <input type="text" id="businessTimeEnd"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate_cz"
										style="width: 140px" />
								</div>
								<div class="bb_czline">
							...
							<div class="bb_line hidemore">
								<div class="bb_czline">
									<label>计划单号：</label> <input type="text" id="planNo"
										placeholder="请输入计划单号">
								</div>
								<div class="bb_czline">
									<label>运单号：</label> <input type="text" id="billNo"
										placeholder="请输入运单号">
								</div>
								<div class="bb_czline">
									<label>货物名称：</label> <input type="text" id="cargoName"
										placeholder="货物名称">
								</div>
							</div>
							<div class="bb_line hidemore">
								<div class="bb_czline">
									<label>车牌号：</label> <input type="text" id="vehicleNo"
										placeholder="请输入车牌号">
								</div>
								<div class="bb_czline">
									<label>路线：</label> <input type="text" id="routeName"
										placeholder="请输入路线">
								</div>
								<div class="bb_czline">
							...
							<div class="bb_line hidemore">
								<div class="bb_czline">
									<label>司机姓名：</label> <input type="text" id="driverName"
										placeholder="请输入司机姓名">
								</div>
								<div class="bb_czline">
								...
								<div class="bb_czline">
									<label>发货方：</label> <input type="text" id="sendMan"
										placeholder="请输入发货方">
								</div>
							</div>
							<div class="bb_line hidemore">
								<div class="bb_czline">
									<label>发货人： </label> <input type="text" id="sendPersion"
										placeholder="请输入发货人">
								</div>
								<div class="bb_czline">
									<label>收货方： </label> <input type="text" id="receiptMan"
										placeholder="请输入收货方">
								</div>
								<div class="bb_czline">
									<label>签收人： </label> <input type="text" id="receiptPersion"
										placeholder="请输入签收人">
								</div>
							</div>
							<div class="bb_line hidemore">
								<div class="bb_czline">
									<label>运单创建开始：</label> <input type="text"
										id="billCreaterTimeStart"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate_cz"
										style="width: 140px" />
								</div>
								<div class="bb_czline">
									<label>运单创建结束：</label> <input type="text"
										id="billCreaterTimeEnd"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate_cz"
										style="width: 140px" />
								</div>
								<div class="bb_czline">
									<label>接受运单开始：</label> <input type="text" id="acceptTimeStart"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate_cz"
										style="width: 140px" />
								</div>
							</div>
							<div class="bb_line hidemore">
								<div class="bb_czline">
									<label>接受运单结束：</label> <input type="text" id="acceptTimeEnd"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate_cz"
										style="width: 140px" />
								</div>
								<div class="bb_czline">
									<label>提货确认开始：</label> <input type="text" id="pickupTimeStart"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate_cz"
										style="width: 140px" />
								</div>
								<div class="bb_czline">
									<label>提货确认结束：</label> <input type="text" id="pickupTimeEnd"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate_cz"
										style="width: 140px" />
								</div>
							</div>
							<div class="bb_line hidemore">
								<div class="bb_czline">
									<label>卸货确认开始：</label> <input type="text" id="unloadTimeStart"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate_cz"
										style="width: 140px" />
								</div>
								<div class="bb_czline">
									<label>卸货确认结束：</label> <input type="text"
										id="unloadTimeEndtime"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate_cz"
										style="width: 140px" />
								</div>
								<div class="bb_czline">
									<label>车主姓名：</label> <input type="text" id="ownerName"
										placeholder="请输入车主姓名">
								</div>
							</div>
							<div class="bb_line">
								<div class="bb_czline">
									<label>签收运单开始：</label> <input type="text" id="signTimeStart"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate_cz"
										style="width: 140px" />
								</div>
								<div class="bb_czline">
									<label>签收运单结束：</label> <input type="text" id="signTimeEnd"
										onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="Wdate_cz"
										style="width: 140px" />
								</div>
								<div class="bb_czline">
										...
										<div class="position_more">
											<div class="c_Screen">
												<label>更多筛选条件</label> <span><img
													src="${trRoot}/tianrui/images/more2.png" id="gengduo"></span>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="baob_table" style="overflow-x: scroll;">
						...
						<table id="report" style="white-space: nowrap"
	...
	<script type="text/javascript"
		src="/resources/js/report/all/bill.js?1017"></script>
	<script type="text/javascript">
		$(function() {
			$(".c_Screen").on(
					'click',
					function() {
						...
						if (div_hs.css("display") == 'none') {
							$("#gengduo").attr('src',
									"${trRoot}/tianrui/images/more2.png");
						} else {
							$("#gengduo").attr('src',
									"${trRoot}/tianrui/images/more1.png");
						}
					});
