				...
				<div class="car_right">
					...
					<div class="bb_search">
						<div class="bb_line">
	                        <div class="bb_czline">
	                            <label>开始时间：</label>
	                            <input id="starttime" type="text" placeholder="开始时间" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'endtime\');}',dateFmt:'yyyy-MM-dd'})" class="Wdate_cz" style="width: 140px" readonly/>
	                        </div>
	                        <div class="bb_czline">
	                            <label>结束时间：</label>
	                            <input id="endtime" type="text" placeholder="结束时间" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'starttime\');}',dateFmt:'yyyy-MM-dd'})" class="Wdate_cz" style="width: 140px" readonly/>
	                        </div>
	                        <div class="bb_czline">
	                            <label>路线：</label>
	                        ...
	                        <div class="bb_czline">
	                            ...
	                            <select id="billStatus" class="form-control">
									...
									<option value="6">待运费确认</option>
									<option value="7">待付款</option>
									<option value="8">支付完成</option>
								</select>
	                        </div>
	                    </div>
	                    <div class="bb_line">
	                        ...
	                        <div class="bb_czline">
	                            <label>司机姓名：</label>
	                            <input id="drivername" type="text" placeholder="请输入司机姓名">
	                        </div>
	                        <div class="bb_czline">
	                            <label>车牌号：</label>
	                        ...
	                        <div class="bb_czline">
	                            <label>是否委派：</label>
	                            <select id="isAppoint" class="form-control">
	                                <option value="">全部</option>
	                    ...
	                    <div class="bb_line">
	                        ...
	                        <div class="bb_czline">
	                            <label>计划单号：</label>
	                            <input id="planCode" type="text" placeholder="请输入计划单号">
	                        </div>
	                        <div class="bb_czline">
