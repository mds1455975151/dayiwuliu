	                    ...
	                    <div class="bb_dtable">
	                        <table class="table ">
	                            ...
	                            <tr>
	                                ...
	                                <td>
	                                	<c:if test="${v_bill.isAppoint eq '0' }">否</c:if>
	                                	<c:if test="${v_bill.isAppoint eq '1' }">是</c:if>
									</td>
	                                <td>
	                                	<c:if test="${v_bill.isAppoint eq '1' }">
	                                		${v_bill.vendername }
	                                	</c:if>
	                                </td>
	                            </tr>
	                            ...
	                            <tr>
	                                ...
	                                <td>
	                                	<c:if test="${v_bill.isAppoint ne '1' && not empty v_bill.price }">
	                                		<fmt:formatNumber type="number" value="${v_bill.price }" maxFractionDigits="2"/>元
		                                </c:if>
	                                </td>
	                                <td>
	                                	<c:if test="${v_bill.isAppoint ne '1' && not empty v_bill.trueweight && not empty v_bill.price }">
	...
	<script type="text/javascript">
		$(function(){
			...
			$('.backBtn').off('click').on('click',function(){
				window.location.href='/trwuliu/venderreport/main';
			});
		});
	</script>
</body>
