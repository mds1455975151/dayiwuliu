 ...
 */
@Controller
@RequestMapping("trwuliu/ownerreport")
public class OwnerReportAction {
	
	private static Logger logger = LoggerFactory.getLogger(OwnerReportAction.class); 
	...
	public ModelAndView detail(ReportReq req){
		ModelAndView view = new ModelAndView("report/owner/detail");
		try {
			ReportResp resp = billReportService.querReportDetail(req, true);
