	 ...
	 <div class="container">
		<!--后台右侧布局begin-->
            ...
            <div class="textBox">
            	...
            	<p style="text-align: center;font-size: 24px;">中原大易科技有限公司运输业务电子回单</p>
		                <p><div style="float:left">运单号：${agreement.billNo }&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		                	运单日期：${agreement.dateAcctept } </div> 
		               		 <div style="float:right;">回单日期：${agreement.dateUnloading }</div>
		                </p>
                <table width="100%" border="1" cellspacing="0" cellpadding="0">
                   ...
                   <tr>
                        ...
                        <td rowspan="3">${agreement.dateUnloading }</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2">${agreement.trueweight }</td>
