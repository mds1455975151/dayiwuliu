                    ...
                    <div>
                            <div>
                                <div>
                                    <div class="ht_div">
                                        <!-- <label>司机姓名：</label> -->
                                        <input type="text" onchange="firstPage();" id="username" placeholder=" " hidden="true">
                                    </div>
                                    <!-- <div class="ht_div">
                                        <label>司机账号：</label>
                                        <input type="text" onchange="firstPage();" id="cellphone" placeholder=" " hadden="true">
                                    </div> -->
                                    
                                    <!-- <div>
                                        <button onclick="driverSearch();" type="button" hadden="true"></button>
...
<!--失败原因begin-->
<div class="modal fade" id="yuanyin" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document" >
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<script type="text/javascript" src="/resources/js/driverDetail.js?1209" ></script>
<script type="text/javascript">
    //upImg();
     $(function(){
