...
<body>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="contuser_search">
							<div class="ht_div">
								<label>车主类别：</label> <select id="personalType"
									class="form-control">
							...
							<div class="ht_div">
								<label>车主账号：</label> <input type="text" id="cellphone"
									placeholder=" ">
							</div>
							<div class="ht_div">
								<label>公司/车主名：</label> <input type="text" id="username"
									placeholder=" ">
							</div>
							<div class="ht_div">
						...
						<div class="contuser_search">
							<div class="ht_div">
								<label>认证时间：</label> <input type="text" id="subtimefor"
									onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:00:00'})"
									class="Wdate" style="width: 160px" /> <i>-</i> <input
									type="text" id="subtimeend"
									onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:00:00'})"
									class="Wdate" style="width: 160px" />
							</div>
							<div class="ht_div">
								<label>车牌号码:</label> <input type="text" id="vehicleno">
							</div>
							<div class="ht_divbtn">
								<button class="btn btnblue " onclick="driverSearch();"
									type="button">搜索</button>
								<button class="btn btngreen" onclick="clearSearch();"
				...
				<div class="modal-body">
					<div class="contuser_search">
						<div class="chezhu_div">
							<label>查询条件：</label> <input id="driverSearch" type="text"
								placeholder=" ">
						</div>
						<div class="ht_divbtn">
							<button class="btn btnblue" onclick="driverdetails(1,0);"
								type="button">搜索</button>
							<button class="btn btngreen" onclick="clearDriver()"
								type="button">重置</button>
						</div>
					</div>
	...
	<!--承运商详情begin-->
	<div class="modal fade" id="chengyun" role="dialog"
		aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document" style="width: 700px">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<div class="contuser_search">
						<div class="chezhu_div">
							<label>查询条件：</label> <input id="ownersearch" type="text"
								placeholder=" ">
						</div>
						<div class="ht_divbtn">
							<button class="btn btnblue" onclick="vehicOwner(1,0);"
								type="button">搜索</button>
							<button class="btn btngreen" onclick="clearDriver()"
								type="button">重置</button>
						</div>
	...
	<!--查看详情end-->
	<!--删除begin-->
	<div class="modal fade" id="dele" role="dialog"
		aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" data-dismiss="modal"
						onclick="deleteMember()">确定</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
				</div>
			</div>
		</div>
	...
	<!--删除end-->
	<!--停用begin-->
	<div class="modal fade" id="tingyong" role="dialog"
		aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<input type="hidden" id="memid" value=""> <input
						type="hidden" id="statustype" value="">
					<h4>
						<span id="satus"></span>
					</h4>
				...
				<div class="modal-footer">
					<button type="button" onclick="changeType();" data-dismiss="modal"
	...
	<!--停用end-->
	<!--启用begin-->
	<div class="modal fade" id="qiyong" role="dialog"
		aria-labelledby="myModalLabel">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
	...
	<script type="text/javascript"
		src="${scriptsRoot }/bootstrap-datetimepicker.zh-CN.js"
	...
	<script type="text/javascript"
		src="/resources/js/adminMember/chezhu_manager.js?1021"></script>
	<script type="text/javascript"
