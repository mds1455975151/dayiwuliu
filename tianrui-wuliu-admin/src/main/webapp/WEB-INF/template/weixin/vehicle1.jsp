...
<div class="maple-tab">
    <ul>
        <li onclick="yiShenpage('vehicle1')" class="active">已审核</li>
        <li onclick="yiShenpage('vehicle')">待审核</li>
    </ul>
</div>
...
<script type="text/javascript" src="/resources/js/weixin/vehicle.js?15" ></script>
