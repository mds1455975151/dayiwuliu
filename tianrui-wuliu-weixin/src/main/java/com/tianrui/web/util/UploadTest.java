...
//            ftpClient.connect(new InetSocketAddress(ip, port)); 
    ...
    public static void main(String agrs[]){  
        ...
        UploadTest ftp = new UploadTest();  
        /* 
         * 使用默认的端口号、用户名、密码以及根目录连接FTP服务器 
         */  
        try  
        {  
            ftp.connectServer("47.91.240.215", 22, "root", "devinlsj@401021", "/data");  
        } catch (FtpProtocolException e)  
        {  
        	
            e.printStackTrace(); 
        }  
        String localfile = "H:\\banktype.txt";  
        String remotefile = "/data/banktype.txt";  
        // 上传  
        try  
        {  
