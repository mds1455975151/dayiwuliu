package com.tianrui.quartz.listener;
...
public class EtcFileSupportListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent evt) {
		...
		File etcFileSupportFile = new File(System.getProperty("catalina.home") + "/etc/trwlSchedule/");
		...
		try {
			...
			logger.error("在添加/etc/trwlSchedule目录至Classpath时出现异常", e);
		}
	}
