...
public class MessageGroup {
    ...
    private String chinnlId;

    private String chinnlType;
    ...
    public String getChinnlId() {
        return chinnlId;
    }

    public void setChinnlId(String chinnlId) {
        this.chinnlId = chinnlId == null ? null : chinnlId.trim();
    }

    public String getChinnlType() {
        return chinnlType;
    }

    public void setChinnlType(String chinnlType) {
        this.chinnlType = chinnlType == null ? null : chinnlType.trim();
    }
