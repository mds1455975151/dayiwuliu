...
public class BaiduPushUtilsOwner {

	static String android_apiKey = "WOYrCYh8F9Mhs1ynFQMYtYHN";
	static String android_secretKey = "GSubAfBXto3XlAuIdhWgHyveqOfguxyF";
	
	static String ios_apiKey = "QYLQjwjrBDRloGPOaAzEX4PC";
	static String ios_secretKey = "4tiiX0z1Mqoenopwhuc6DCs2jsGjSYpn";
...
//		pushMsgToTage("vender_push_tage", 4, "这是一个测试消息", "123");
		...
		System.out.println("wqe="+QueryDeviceNumInTag("GROUP_OWNER", 3));
